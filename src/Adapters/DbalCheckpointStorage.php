...
namespace Internezzo\CIRS\Core\Adapters;
...
final class DbalCheckpointStorage implements CheckpointStorage, ProvidesSetup
{
    ...
    public function __construct(
        ...
        if ($platform === null) {
            throw new \InvalidArgumentException(sprintf('Failed to determine database platform for database "%s"', $this->connection->getDatabase()), 1691422912);
        }
    ...
    public function setup(): void
    {
        ...
        if (!$schemaManager instanceof AbstractSchemaManager) {
            throw new \RuntimeException('Failed to retrieve Schema Manager', 1691422985);
        }
        $schema = new Schema();
